...
Route::get('players', [App\Http\Controllers\Api\UserController::class, 'AllPlayers']);// return all players with medium success rate
...
Route::get('players/ranking', [App\Http\Controllers\Api\UserController::class, 'RankAll']);// list all players with medium success rate
Route::get('players/ranking/loser', [App\Http\Controllers\Api\UserController::class, 'Loser']);// list the player with lower success rate
